...
class ICM42688 {
 public:
     ...
     */
	ICM42688(SPI_HandleTypeDef * bus, GPIO_TypeDef * csPinBank, uint16_t csPin, uint32_t spiLSPrescaler, uint32_t spiHSPrescaler);
 ...
 protected:
	...
	uint16_t                  _csPin;
	uint32_t _spiLSPrescaler;
	uint32_t _spiHSPrescaler;
