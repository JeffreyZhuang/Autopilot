...
bool Plane::check_new_imu_data(Subscription_handle subscription_handle) const
{
	return _imu_data.timestamp > subscription_handle.timestamp;
}

Plane::IMU_data Plane::get_imu_data(Subscription_handle subscription_handle) const
{
...
bool Plane::check_new_mag_data(Subscription_handle subscription_handle) const
{
	return _mag_data.timestamp > subscription_handle.timestamp;
}

Plane::Mag_data Plane::get_mag_data(Subscription_handle subscription_handle) const
{
...
bool Plane::check_new_baro_data(Subscription_handle subscription_handle) const
{
	return _baro_data.timestamp > subscription_handle.timestamp;
}

Plane::Baro_data Plane::get_baro_data(Subscription_handle subscription_handle) const
{
...
bool Plane::check_new_gnss_data(Subscription_handle subscription_handle) const
{
	return _gnss_data.timestamp > subscription_handle.timestamp;
}

Plane::GNSS_data Plane::get_gnss_data(Subscription_handle subscription_handle) const
{
...
bool Plane::check_new_of_data(Subscription_handle subscription_handle) const
{
	return _of_data.timestamp > subscription_handle.timestamp;
}

Plane::OF_data Plane::get_of_data(Subscription_handle subscription_handle) const
{
...
bool Plane::check_new_ahrs_data(Subscription_handle subscription_handle) const
{
	return _ahrs_data.timestamp > subscription_handle.timestamp;
}

Plane::AHRS_data Plane::get_ahrs_data(Subscription_handle subscription_handle) const
{
...
bool Plane::check_new_pos_est_data(Subscription_handle subscription_handle) const
{
	return _pos_est_data.timestamp > subscription_handle.timestamp;
}

Plane::Pos_est_data Plane::get_pos_est_data(Subscription_handle subscription_handle) const
{
