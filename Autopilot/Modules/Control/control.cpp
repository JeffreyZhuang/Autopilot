...
void Control::update_mission()
{
	...
	_plane->throttle_setpoint = speed_controller.get_output(_plane->tecs_energy_total, _plane->tecs_energy_total_setpoint, params.thr_kp, 0.01, 0, 1, 0, 1, params.throttle_cruise);
